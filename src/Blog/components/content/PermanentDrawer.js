      ...
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, backgroundColor: "#484848"}}>
        <Toolbar>
          ...
          <Typography variant="h6" component="div" sx={{flexGrow: 1}}>
           ...
           <a class='navElements' href="http://localhost:3000/">
            <Button color="inherit" style={{color: "white"}} className='navElements'>HOME</Button>
          </a>

           <a class='naveElements' href="http://localhost:3000/addPost">
            <Button color="inherit" style={{color: "white"}} className = 'naveElements'>POST</Button>
           </a>
        </Toolbar>
      </AppBar>
      <Drawer
